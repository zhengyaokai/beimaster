package bmatser.plugin.unionpay.config;
...
//	private final static String UPOP_BASE_URL = "http://202.101.25.184/UpopWeb/api/";
	...
	/* 后台交易测试环境 */
//	private final static String UPOP_BSPAY_BASE_URL = "http://202.101.25.184/UpopWeb/api/";
...
//	private final static String UPOP_BSPAY_BASE_URL = "https://www.epay.lxdns.com/UpopWeb/api/";
	...
	/* 查询交易测试环境 */
//	private final static String UPOP_QUERY_BASE_URL = "http://202.101.25.184/UpopWeb/api/";
...
//	private final static String UPOP_QUERY_BASE_URL = "https://www.epay.lxdns.com/UpopWeb/api/";
	...
	// 商户代码
	public final static String merCode = "898320548160153";

	// 商户名称
	public final static String merName = "苏州惠全信息科技有限公司";

	public final static String merFrontEndUrl = "http://bmatser.com/page/buyer/procureCenter/procureMain.jsp";

	public final static String merBackEndUrl = "http://bmatser.com/unionpayres!unionPayRes.action";
	...
	public final static String securityKey = "BGVFYUGUZSDTGHGUISDTRGHSTRHJY";
