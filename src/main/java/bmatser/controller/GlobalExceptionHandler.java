...
import bmatser.util.JsonResult;
...
public class GlobalExceptionHandler {
    ...
    public String runtimeExceptionHandler(HttpServletResponse response,RuntimeException ex) {
    ...
    @ExceptionHandler({GdbmroException.class})
    public String requestGdbmroException(HttpServletResponse response,GdbmroException ex) {
    	response.setStatus(500);
        return resultFormat(-1, ex);
    }
...
//        ex.printStackTrace();
        ...
        System.out.println(JsonResult.failed(code, ex.getMessage()));
