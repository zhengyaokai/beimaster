...
//	"MIGEAgEAMBAGByqGSM49AgEGBSuBBAAKBG0wawIBAQQgS7jLCjZJtcDBpsr78Nvk\n" +
//	"ilOK0inE1xEwd31+HAW57dmhRANCAAQqm2sWiiUtPJCUf+Tl/s7QoMyKguGDZ7TL\n" +
//	"7jxSQYPZM3v7eQaoIeSz08bDXAApoUW3iZU6i+HDNpr7l2RYrLXH\n" +
//	"-----END PRIVATE KEY-----";
//    
//	//change public pem string to public string
//    private static String pubStr = "-----BEGIN PUBLIC KEY-----\n"+
//	"MFYwEAYHKoZIzj0CAQYFK4EEAAoDQgAEKptrFoolLTyQlH/k5f7O0KDMioLhg2e0\n"+
//	"y+48UkGD2TN7+3kGqCHks9PGw1wAKaFFt4mVOovhwzaa+5dkWKy1xw==\n"+
//	"-----END PUBLIC KEY-----";		
//    
//
...
//
//            // generate signature
//            GenTLSSignatureResult result = GenTLSSignatureEx(1400024831, "宫品会");
...
//		    	
//            // check signature
//            CheckTLSSignatureResult checkResult = CheckTLSSignatureEx(result.urlSig, 1400024831, "宫品会");
...
//			String urlSig,
//			long sdkAppid, 
//			String identifier) throws DataFormatException {
//
//		CheckTLSSignatureResult result = new CheckTLSSignatureResult();	
//        Security.addProvider(new BouncyCastleProvider());
//		
...
//				"TLS.expire_after:" + sigExpire + "\n";
//		
//	        Reader reader = new CharArrayReader(pubStr.toCharArray());
//	        PEMParser  parser = new PEMParser(reader);
//	        JcaPEMKeyConverter converter = new JcaPEMKeyConverter();
//	        Object obj = parser.readObject();
//	        parser.close();
