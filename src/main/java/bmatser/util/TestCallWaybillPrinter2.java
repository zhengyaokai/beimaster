...
public class TestCallWaybillPrinter2 {
	
	public static void main(String [] args) throws Exception{
		TestCallWaybillPrinter2.WayBillPrinterTools();
	...
	public static void WayBillPrinterTools() throws Exception{
		 ...
		 */
		String url3 = "http://bmatser.com:4040/sf/waybill/print?type=V2.0_poster_100mm150mm&output=image";
...
//		dto.setConsignerTel("0755-33123456");
		...
		dto.setDeliverAddress("百花苑西区7-2-201室");//详细地址建议最多30个字  字段过长影响打印效果
...
//		dto.setCargoInfoDtoList(cargoInfoList);
		...
		System.out.println(JSONObject.parseObject(str).getJSONArray("result").get(0));;
